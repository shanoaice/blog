...
> 目前, 我暂时已经不再维护我的 DN42 网络 (AS4242423743).
> As of now, I am not maintaining my DN42 network (AS4242423743)
...
我在 DN42 中运营 AS4242423743 (CHATNOIR-AS), 目前*暂时不再维护*。有 peer 请求可以联系我的 Telegram 账号 @mika_akizuki (暂时只接受 WireGuard Tunnel).

I operate AS4242423743 (CHATNOIR-AS) in DN42, with *0* nodes currently online (*maintainence suspended*). If you want to peer with me, please send a email to `mashiro350 [at] protonmail [dot] com`.
...
如果想与我建立对等互联，请联系 `mashiro350 [at] protonmail [dot] com` 或 Telegram `@mika_akizuki`.

For peering requsets, please contact `mashiro350 [at] protonmail [dot] com` or `@mika_akizuki` on Telegram.
